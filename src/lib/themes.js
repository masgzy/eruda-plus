...
export default {
  ...
  Light: createLightTheme({
    ...
    commentColor: '#236e25',
    cssProperty: '#c80000',
    consoleWarnBackground: '#fef7e0',
    consoleWarnForeground: '#9a6b00',
    consoleWarnBorder: '#f9e6a0',
    consoleErrorBackground: '#fcecec',
    consoleErrorForeground: '#d93025',
    consoleErrorBorder: '#f6d5d5',
  }),
  // Chrome DevTools "Dark" palette.
  Dark: createDarkTheme({
    darkerBackground: '#292a2d',
    background: '#202124',
    foreground: '#e8eaed',
    ...
    keywordColor: '#c58af9',
    numberColor: '#7ba7ff',
    operatorColor: '#9aa0a6',
    linkColor: '#8ab4f8',
    textColor: '#9aa0a6',
    tagNameColor: '#5db0d7',
    functionColor: '#d5d5d5',
    attributeNameColor: '#75b7ff',
    commentColor: '#898989',
    consoleWarnBackground: '#332a00',
    consoleWarnForeground: '#fdd663',
    consoleWarnBorder: '#665500',
    consoleErrorBackground: '#3a1d1f',
    consoleErrorForeground: '#f28b82',
    consoleErrorBorder: '#5c2b2d',
  }),
